...
public class ShotyByFoodAdapter extends RecyclerView.Adapter<ShotyByFoodAdapter.Holder> {
    Context context;
    ...
    public ShotyByFoodAdapter(Context context) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Holder holder = new Holder(LayoutInflater.from(context).inflate(R.layout.item_food_short_by, parent, false));
